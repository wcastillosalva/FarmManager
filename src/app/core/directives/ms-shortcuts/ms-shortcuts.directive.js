(function () {
    ...
    /** @ngInject */
    function MsShortcutsController($scope, $cookies, $document, $timeout, $q, msNavigationService, $filter, localStorageFactory) {
        var vm = this;
        // Data
        vm.query = '';
        vm.queryOptions = {
        ...
        function loadShortcuts() {
            ...
            var shortcuts = farmManagerObj.shortcuts;
        ...
        function saveShortcuts() {
            ...
            farmManagerObj.shortcuts = vm.shortcuts;
